<section>
    <footer style="padding-top: 106px;padding-bottom: 106px;background: #292F78;">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div style="width: 228px;height: 93.82px;background: url(&quot;assets/img/Logo/Logo%20Sampoerna%20Academy%20white.png&quot;) center / contain no-repeat;"></div>
                    <div style="padding-top: 24px;padding-bottom: 24px;">
                        <p class="fw-light" style="font-family: Campton;color: var(--bs-white);margin-bottom: 0px;">L’Avenue School Jln. Raya Pasar Minggu, Kav. 16 Pancoran, Jakarta 12780 (021) 50 222 234 / +62821 62 800 800</p>
                    </div>
                    <div class="d-flex flex-row justify-content-between" style="padding-right: 72px;"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-instagram fs-3" style="color: var(--bs-white);font-family: Campton;padding-left: 0px;padding-right: 0px;">
                            ...
                            </svg></a><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook fs-3" style="color: var(--bs-white);font-family: Campton;padding-left: 0px;padding-right: 0px;">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"></path>
                            </svg></a><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-youtube fs-3" style="color: var(--bs-white);font-family: Campton;padding-left: 0px;padding-right: 0px;">
                            ...
                            </svg></a><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-tiktok fs-3" style="color: var(--bs-white);font-family: Campton;padding-left: 0px;padding-right: 0px;">
                ...
                <div class="col-md-3">
                    <div>
                        ...
                        <div class="d-flex flex-row align-items-lg-center align-items-xxl-center" style="margin-top: 24px;">
                            ...
                            <div style="background: url(&quot;assets/img/Logo/acc%20diploma%20programe.png&quot;) center / contain no-repeat;width: 268px;height: 82px;"></div>
                        </div>
                    </div>
                </div>
            </div>
