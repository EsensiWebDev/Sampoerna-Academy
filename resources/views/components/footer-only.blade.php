        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="d-flex flex-row justify-content-between" style="padding-right: 72px;"><a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                 viewBox="0 0 16 16" class="bi bi-instagram fs-3"
                                 style="color: var(--bs-white);font-family: Campton;padding-left: 0px;padding-right: 0px;">
                                <path
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                 viewBox="0 0 16 16" class="bi bi-facebook fs-3"
                                 style="color: var(--bs-white);font-family: Campton;padding-left: 0px;padding-right: 0px;">
                                <path
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                 viewBox="0 0 16 16" class="bi bi-youtube fs-3"
                                 style="color: var(--bs-white);font-family: Campton;padding-left: 0px;padding-right: 0px;">
                                <path
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                 viewBox="0 0 16 16" class="bi bi-tiktok fs-3"
                                 style="color: var(--bs-white);font-family: Campton;padding-left: 0px;padding-right: 0px;">
                                <path
                ...
                <div class="col-md-3 mt-4 mt-md-0 d-lg-flex justify-content-lg-center align-items-lg-start">
                    <div>
                        <h1 class="fs-4"
                ...
                <div class="col-md-3">
                    <div>
                        <h1 class="fs-4"
                            style="font-family: Campton;color: var(--bs-white);margin-bottom: 0px;">{{ __("ACCREDITED BY") }}</h1>
            ...
            <p class="fw-light text-center"
               style="font-family: Campton;color: var(--bs-white);">{{ __("©2024 Sampoerna Academy. All Rights Reserved") }}</p>
        </div>
    </footer>
</section>
