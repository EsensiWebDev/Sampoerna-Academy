        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <div class="ms-auto">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item d-flex flex-row align-items-xxl-center" style="border-bottom: 2px solid #CE3827 ;"><a class="nav-link fs-5 link-body-emphasis" href="/aboutus.html" style="font-family: Campton;padding-right: 0px;">{{ __('aboutUs') }}</a>
                        <div class="nav-item dropdown" style="font-family: Campton;"><a class="fs-5 link-body-emphasis" aria-expanded="false" data-bs-toggle="dropdown" href="aboutus.html" style="color: var(--bs-white);"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none">
                            ...
                            <div class="dropdown-menu" style="padding-left: 8px;padding-right: 8px;border-radius: 0px;"><a class="dropdown-item fw-light" href="/aboutus/ourapproach.html">{{ __("Our Approach") }}</a>
                                <div class="dropdown-divider" style="border-width: 1px;border-color: rgb(0,0,0);margin-left: 14px;margin-right: 14px;"></div><a class="dropdown-item fw-light" href="/aboutus/leadership.html">{{ __("Leadership") }}</a>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item" style="font-family: Campton;"><a class="nav-link fs-5 link-body-emphasis" href="/steam.html" style="color: var(--bs-white);">{{ __("steam") }}</a></li>
                    <li class="nav-item d-flex flex-row align-items-xxl-center"><a class="nav-link fs-5 link-body-emphasis" href="/academics.html" style="font-family: Campton;padding-right: 0px;">{{ __("academics") }}</a>
                        <div class="nav-item dropdown" style="font-family: Campton;"><a class="fs-5 link-body-emphasis" aria-expanded="false" data-bs-toggle="dropdown" href="academics.html" style="color: var(--bs-white);"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none">
                            ...
                            <div class="dropdown-menu" style="padding-top: 8px;padding-bottom: 8px;padding-left: 8px;padding-right: 8px;border-radius: 0px;"><a class="dropdown-item fw-light" href="/academics/earlyyears.html">{{ __("Early Years") }}</a>
                    ...
                    <li class="nav-item d-flex flex-row align-items-xxl-center"><a class="nav-link fs-5 link-body-emphasis" href="/activities.html" style="font-family: Campton;padding-right: 0px;">{{ __("Activities") }}</a>
                        <div class="nav-item dropdown" style="font-family: Campton;"><a class="fs-5" aria-expanded="false" data-bs-toggle="dropdown" href="#" style="color: var(--bs-white);"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none">

                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5.29289 7.29289C5.68342 6.90237 6.31658 6.90237 6.70711 7.29289L10 10.5858L13.2929 7.29289C13.6834 6.90237 14.3166 6.90237 14.7071 7.29289C15.0976 7.68342 15.0976 8.31658 14.7071 8.70711L10.7071 12.7071C10.3166 13.0976 9.68342 13.0976 9.29289 12.7071L5.29289 8.70711C4.90237 8.31658 4.90237 7.68342 5.29289 7.29289Z" fill="currentColor"></path>
                                </svg></a>
                            <div class="dropdown-menu dropdown-menu-end" style="padding-left: 8px;padding-right: 8px;border-radius: 0px;"><a class="dropdown-item fw-light" href="/activities/extracurricular.html">{{ __("Extracurricular") }}</a>
                                <div class="dropdown-divider" style="margin: 8px 14px;border-width: 1px;border-color: rgb(0,0,0);"></div><a class="dropdown-item fw-light" href="/activities/awards&amp;achievements.html">{{ __("Awards & Achievements") }}</a>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item d-flex flex-row align-items-xxl-center"><a class="nav-link fs-5 link-body-emphasis" href="/admissions.html" style="font-family: Campton;padding-right: 0px;">{{ __("Admissions") }}</a>
                        <div class="nav-item dropdown" style="font-family: Campton;"><a class="fs-5" aria-expanded="false" data-bs-toggle="dropdown" href="#" style="color: var(--bs-white);"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none">
