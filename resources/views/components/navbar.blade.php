        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <div class="ms-auto">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item d-flex flex-row align-items-xxl-center"><a class="nav-link fs-5 link-body-emphasis" href="/aboutus.html" style="font-family: Campton;padding-right: 0px;">{{ __('aboutUs') }}</a>
