<section id="leadership">
    <section>
        <div class="d-flex align-items-end" style="height: 600px;background: url(&quot;../assets/img/Banner/Leadership.webp&quot;) center / cover no-repeat;">
    ...
    <section style="margin-top: 200px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-10 offset-lg-2 d-block d-md-none order-3" style="margin-top: 20px; padding-bottom: 0px;">
                    <p class="fs-2 fw-semibold" style="font-family: Campton; color: var(--bs-black); margin-bottom: 0px;">
                ...
                <div class="col-md-12 d-none d-md-block order-md-2" style="position: relative; top: 50px; max-width: 800px; margin: auto; overflow: hidden;">
                    <p class="fs-2 fw-semibold" style="font-family: Campton; color: var(--bs-black); margin-bottom: 0px;">
                        “<br>{{ __("We believe our initiative is the best we can offer") }}<br>
                        {{ __("for our beloved sons and daughters in order") }}<br>
                        {{ __("to contribute to the betterment of Indonesia’s future!") }}
    ...
    <section style="margin-top: 200px;">
        <div class="container" style="margin-bottom: 64px;">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="fs-2" style="font-family: Campton;color: var(--bs-black);">{{ __("Meet Our Principals") }}</h1>
                </div>
            </div>
        </div>
        <div class="container">
    ...
    <section style="margin-top: 200px;">
        <div class="container" style="margin-bottom: 64px;">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="fs-2" style="font-family: Campton;color: var(--bs-black);">{{ __("Meet Our Curriculum Heads") }}</h1>
                </div>
            </div>
        </div>
        <div class="container">
