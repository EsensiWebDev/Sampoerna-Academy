<section id="leadership">
    ...
    <section style="margin-top: 200px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="fs-2 fw-semibold" style="color: var(--bs-black);font-family: Campton;">{{ __("Greetings from the School Director") }}</h1>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row" style="margin-top: 20px;padding-bottom: 0px;">
                <div class="col-md-12 col-lg-10 offset-lg-2">
                    <p class="fs-2 fw-semibold" style="font-family: Campton;color: var(--bs-black);margin-bottom: 0px;">“<br>{{ __("We believe our initiative is the best we can offer") }}<br>{{ __("for our beloved sons and daughters in order") }}<br>{{ __("to contribute to the betterment of Indonesia’s future!") }}</p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 d-flex flex-row align-items-center">
                    <div class="px-0 py-4">
                        <div class="d-flex flex-row">
                            <p class="fw-light" style="font-family: Campton;color: var(--bs-black);font-size: 14px;">{{ __("Sampoerna Academy is an educational institution that upholds Asian values at the forefront of learning. Since its first establishment, the Academy has been producing passionate lifelong learners who are able to meet the challenges of the rapidly changing world, and who care deeply for their fellows and the environment.") }}<br><br>{{ __("High-quality education provided in Sampoerna Academy is not accidental, but intentional. In our schools, we instill 21st Century Skills within the Cambridge International Examination curriculum. We also believe that children learn more by doing. This is why Project Based Learning and STEAM are at the core of our teaching philosophy. ") }}<br><br>{{ __("The era of globalization and the ASEAN Economic Community has greatly impacted Indonesia. Among them is the increased competitiveness as the job market became global. Furthermore, technology advancement has caused a significant shifting in our lives and transformed business models in all sectors.") }}</p>
                        </div>
                        <div style="margin-bottom: 28px;">
                            <h1 class="fs-4 fw-semibold" style="color: var(--bs-black);font-family: Campton;">Dr. Mustafa Guvercin</h1>
                            <p class="fw-light" style="font-family: Campton;color: var(--bs-black);">{{ __("Director of Sampoerna Academy") }}</p>
                        </div>
                    </div>
                </div>
            </div>
