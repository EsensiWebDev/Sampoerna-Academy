                ...
                <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                    <div class="background-container">
                        <div class="d-flex flex-column sub-head align-items-start">
                            <h1 class="fs-2 fw-semibold" style="color: var(--bs-body-bg); font-family: Campton; margin-bottom: 8px;">
                            ...
                            <button class="btn more-info" style="color: var(--bs-body-bg); font-family: Campton; padding:0px;">
                                {{ __("More Info") }}&nbsp;
            ...
            <div class="row" style="padding-bottom: 0px;margin-bottom: 48px;">
                <div class="col-md-12">
                    <h1 class="fs-2 fw-semibold text-center"
                        style="color: var(--bs-black);font-family: Campton;">{{ __("A Journey of Lifelong Learning") }}</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;">
                    <div class="card" style="border-radius: 0px;border-style: none;"><img class="card-img w-100 d-block" width="auto" height="auto"
                                                                                          style="border-radius: 0px;"
                                                                                          src="assets/img/Card/Rectangle%209036.webp">
                        <div
                            class="card-img-overlay d-flex flex-column justify-content-end justify-content-sm-end justify-content-lg-end align-items-lg-start"
                            ...
                            <div class="d-flex flex-row flex-md-column justify-content-between">
                                ...
                                <a href="/academics/early-years" style="color: var(--bs-body-bg);font-family: Campton;">{{ __("More Info") }}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none">
                    ...
                    <div class="card" style="border-radius: 0px;border-style: none;"><img class="card-img w-100 d-block"
                        ...
                        <div
                            ...
                            <div class="d-flex flex-row flex-md-column justify-content-between">
                                ...
                                <a href="/academics/elementary-school" style="color: var(--bs-body-bg);font-family: Campton;">{{ __("More Info") }}
                ...
                <div class="col-md-3" style="padding-left: 0px;padding-right: 0px;">
                    <div class="card" style="border-radius: 0px;border-style: none;"><img class="card-img w-100 d-block"
                        ...
                        <div
                            class="card-img-overlay d-flex flex-column justify-content-end justify-content-lg-end align-items-lg-start"
                            style="border-radius: 0px;background: linear-gradient(rgba(255,255,255,0) 0%, rgba(0,0,0,0.3) 80%);border-style: none;">
                            <div class="d-flex flex-row flex-md-column justify-content-between">
                                <h4 class="fs-5"
                                    style="font-family: Campton;color: var(--bs-body-bg);">{{ __("Middle School") }}</h4>
                                <a href="/academics/middle-school" style="color: var(--bs-body-bg);font-family: Campton;">{{ __("More Info") }}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20"
                                         fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              d="M10.2929 3.29289C10.6834 2.90237 11.3166 2.90237 11.7071 3.29289L17.7071 9.29289C18.0976 9.68342 18.0976 10.3166 17.7071 10.7071L11.7071 16.7071C11.3166 17.0976 10.6834 17.0976 10.2929 16.7071C9.90237 16.3166 9.90237 15.6834 10.2929 15.2929L14.5858 11L3 11C2.44772 11 2 10.5523 2 10C2 9.44772 2.44772 9 3 9H14.5858L10.2929 4.70711C9.90237 4.31658 9.90237 3.68342 10.2929 3.29289Z"
                    ...
                    <div class="card" style="border-radius: 0px;border-style: none;"><img class="card-img w-100 d-block"
                        ...
                        <div
                            ...
                            <div class="d-flex flex-row flex-md-column justify-content-between">
                                ...
                                <a href="/academics/high-school" style="color: var(--bs-body-bg);font-family: Campton;">{{ __("More Info") }}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20"
                                         fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              d="M10.2929 3.29289C10.6834 2.90237 11.3166 2.90237 11.7071 3.29289L17.7071 9.29289C18.0976 9.68342 18.0976 10.3166 17.7071 10.7071L11.7071 16.7071C11.3166 17.0976 10.6834 17.0976 10.2929 16.7071C9.90237 16.3166 9.90237 15.6834 10.2929 15.2929L14.5858 11L3 11C2.44772 11 2 10.5523 2 10C2 9.44772 2.44772 9 3 9H14.5858L10.2929 4.70711C9.90237 4.31658 9.90237 3.68342 10.2929 3.29289Z"
    ...
    <section style="margin-top: 200px;">
        <div class="container">
            <div class="row" style="margin-bottom: 48px;">
                <div class="col-md-12">
                    <h1 class="fs-2 fw-semibold text-center"
                        style="font-family: Campton;color: var(--bs-emphasis-color);">{{ __("Instagram Content") }}</h1>
                </div>
            </div>
    ...
    <section style="margin-top: 200px;" class="d-none d-md-block">
        <div class="container">
            <div class="row" style="margin-bottom: 48px;">
                <div class="col-md-12">
                    <h1 class="fs-2 fw-semibold text-center"
                        style="font-family: Campton;color: var(--bs-emphasis-color);">{{ __("Awards & Achievements") }}</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <div class="card" style="border-style: none;border-radius: 0px;"><img
                        ...
                        <div class="card-body"
                            ...
                            <h1 class="fs-6 fw-semibold card-subtitle mb-2"
                                ...
                                <br>{{ __("Sampoerna Academy Online") }}</h1>
                            <h1 class="fs-6 fw-semibold card-subtitle mb-2"
                                style="font-family: Campton;color: var(--bs-emphasis-color);padding-top: 0px;margin-top: 24px;padding-bottom: 0px;">{{ __("First Place") }}</h1>
                            <p class="fw-light card-text"
                               style="font-family: Campton;">{{ _("The 3rd Tokyo International Youth Piano Competition Final Round") }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card" style="border-style: none;border-radius: 0px;"><img
                        ...
                        <div class="card-body"
                            ...
                            <h1 class="fs-6 fw-semibold card-subtitle mb-2"
                                ...
                                <br>{{ __("Sampoerna Academy Medan") }}</h1>
                            <h1 class="fs-6 fw-semibold card-subtitle mb-2"
                                style="font-family: Campton;color: var(--bs-emphasis-color);padding-top: 0px;margin-top: 24px;padding-bottom: 0px;">{{ __("First Place") }}</h1>
                            <p class="fw-light card-text"
                               style="font-family: Campton;">{{ __("Indonesia Junior Golf Premier league 5") }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card" style="border-style: none;border-radius: 0px;"><img
                        ...
                        <div class="card-body"
                            ...
                            <h1 class="fs-6 fw-semibold card-subtitle mb-2"
                                ...
                                <br>{{ __("Sampoerna Academy Pakuwon Indah") }}</h1>
                            <h1 class="fs-6 fw-semibold card-subtitle mb-2"
                                style="font-family: Campton;color: var(--bs-emphasis-color);padding-top: 0px;margin-top: 24px;padding-bottom: 0px;">{{ __("Bronze Medal") }}</h1>
                            <p class="fw-light card-text"
                               style="font-family: Campton;">{{ __("International Singapore Mathematics Competition 2024") }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card" style="border-style: none;border-radius: 0px;"><img
                        ...
                        <div class="card-body"
                            ...
                            <h1 class="fs-6 fw-semibold card-subtitle mb-2"
                                ...
                                <br>{{ __("Sampoerna Academy Pakuwon Indah") }}</h1>
                            <h1 class="fs-6 fw-semibold card-subtitle mb-2"
                                style="font-family: Campton;color: var(--bs-emphasis-color);padding-top: 0px;margin-top: 24px;padding-bottom: 0px;">{{ __("Honour Mention") }}</h1>
                            <p class="fw-light card-text"
                               style="font-family: Campton;">{{ __("The 2024-2025 Third SIAT International Youth Art Competition") }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <h1 class="fs-2 fw-normal text-center"
                        style="font-family: Campton; color: var(--bs-emphasis-color);">{{ __("An Overview of Sampoerna Academy") }}</h1>
                </div>
            </div>
            <div class="row">
                <style>
                    .vertical-line {
                        ...
                        right: 0; /* Position at the right edge of the column */
                        width: 2px; /* Width of the vertical line */
                        height: 80%; /* Adjust based on desired height */
                        background-color: #000000; /* Color of the line; match or adjust as needed */
    ...
    <section>
        <div class="container" style="margin-bottom: 50px;">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="fs-2 fw-semibold text-center"
                        style="font-family: Campton;color: var(--bs-emphasis-color);">{{ __("Where Our Students Shine") }}</h1>
                </div>
            </div>
        </div>
