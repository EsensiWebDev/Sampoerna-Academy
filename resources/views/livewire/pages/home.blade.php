            ...
            <div class="row">
                <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                    <div class="background-container">
                        <div class="d-flex flex-column sub-head">
                            ...
                            <a href="#" class="more-info" style="color: var(--bs-body-bg); font-family: Campton;">
                                {{ __("More Info") }}&nbsp;
                ...
                <div class="col-12 p-0"> <!-- Removed padding for full width -->
                    <div class="row no-gutters"> <!-- Use no-gutters to prevent gaps -->
                        <div class="col-6 col-md-2 text-center">
                            ...
                            <p class="fw-light"
                               style="font-family: Campton; color: var(--bs-black);">{{ __("IGCSE Pass Rate") }}</p>
                        </div>
                        <div class="col-6 col-md-2 text-center">
                            <h1 style="font-family: Campton; color: #292F78;">1 of 3</h1>
                            <p class="fw-light"
                               style="font-family: Campton; color: var(--bs-black);">{{ __("Students Gets") }}
                                <br>{{ __("Distinction (A* & A)") }}</p>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <h1 style="font-family: Campton; color: #292F78;">1 of 2</h1>
                            <p class="fw-light"
                               style="font-family: Campton; color: var(--bs-black);">{{ __("from Medan & Surabaya") }}
                                <br>{{ __("Gets Distinction (A* & A)") }}</p>
                        </div>
                        <div class="col-6 col-md-2 text-center">
                            <p class="fw-light"
                               style="font-family: Campton; color: var(--bs-black);">{{ __("BSD & L'Avenue Has") }}</p>
                            <h1 style="font-family: Campton; color: #292F78;">&gt;97%</h1>
                            <p class="fw-light"
                               style="font-family: Campton; color: var(--bs-black);">{{ __("Pass Rate") }}</p>
                        </div>
                        <div class="col-12 col-md-3 text-center">
                            <h1 style="font-family: Campton; color: #292F78;">93%</h1>
                            <p class="fw-light"
                               style="font-family: Campton; color: var(--bs-black);">{{ __("of our students were") }}
                                <br>{{ __("awarded the IB Diploma") }}</p>
                        </div>
                    </div>
                </div>
            </div>
