<section id="activities">
    <section>
        <div class="d-flex align-items-end" style="height: 600px;background: url(&quot;assets/img/Banner/activities.webp&quot;) center / cover no-repeat;">
                ...
                <div class="col-md-12">
                    <div class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="2000" data-bs-pause="false" data-bs-keyboard="false" data-bs-touch="false" id="carousel-1">
                        <div class="carousel-inner">
                            <div class="carousel-item active"><img class="img-fluid w-100 d-block" src="/assets/img/Carousel/carousel%20activities%20left.webp" alt="Slide Image"></div>
                            <div class="carousel-item"><img class="img-fluid w-100 d-block" src="/assets/img/Carousel/carousel%20activities%20middle.webp" alt="Slide Image"></div>
                            <div class="carousel-item"><img class="img-fluid w-100 d-block" src="/assets/img/Carousel/carousel%20activities%20right.webp" alt="Slide Image"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top: 32px;">
                <div class="col-md-12">
                    <div class="d-xxl-flex justify-content-xxl-center">
                        <a href="/activities/extracurricular" wire:navigate.hover>
                        <button class="btn btn-primary" type="button" style="border-style: none;font-family: Campton;color: var(--bs-white);">{{ __("Explore School Activities") }}&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none">
            ...
            <div class="container">
                <div class="slick-slider">
                    <div class="slick-item" style="border-style: none; border-radius: 0px;">
                        <img class="card-img-top" src="assets/img/Card/Cover.webp" style="border-radius: 0px;">
