                        ...
                        <div class="card-body"
                            ...
                            <form method="POST" action="/form">
                                <div style="margin-bottom: 40px;"><label class="form-label"
                                        style="color: var(--bs-black);font-family: Campton;">{{ __('Parents Name') }}<span
                                            class="text-danger">*</span></label><input class="form-control"
                                        type="text"></div>
                                <div style="margin-bottom: 40px;"><label class="form-label"
                                        style="color: var(--bs-black);font-family: Campton;">{{ __('Kids Name') }}<span
                                            class="text-danger">*</span></label><input class="form-control"
                                        type="text"></div>
                                <div class="d-flex flex-row" style="margin-bottom: 40px;">
                                    <div class="flex-fill" style="padding-right: 10px;"><label class="form-label"
                                            style="color: var(--bs-black);font-family: Campton;">{{ __('Phone Number') }}<span
                                                class="text-danger">*</span></label><input class="form-control"
                                            type="tel"></div>
                                    <div class="flex-fill" style="padding-left: 10px;"><label class="form-label"
                                            style="color: var(--bs-black);font-family: Campton;">Email<span
                                                class="text-danger">*</span></label><input class="form-control"
                                            type="email"></div>
                                </div>
                                <div style="margin-bottom: 40px;"><label class="form-label"
                                ...
                                <div class="d-lg-flex justify-content-lg-end"><button class="btn btn-primary"
                                        type="button"
                                        style="border-style: none;border-radius: 12px;padding-left: 40px;padding-right: 40px;padding-top: 20px;padding-bottom: 20px;font-family: Campton;width: 320px;">{{ __('Submit') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
