    ...
    <section style="margin-bottom: 200px;">
        <div class="d-flex align-items-end" style="height: 600px;background: url(&quot;../assets/img/Carousel/surabaya.jpg&quot;) center / cover no-repeat;">
            <div class="container" style="padding-bottom: 64px;">
                <div class="row">
                    <div class="col-md-12">
                        <h1 style="font-family: Campton;color: var(--bs-white);">{{ __("Our Schools") }}</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div style="margin-top: 24px;">
                        <p class="fs-5 fw-light" style="font-family: Campton; color: var(--bs-black);">
                            ...
                            {{ __("STEAM resources and the International Cambridge curriculum. Our Surabaya School are located in Lakarsantri and Banjar Sugihan.") }}
                        </p>
                    </div>
        ...
        <div class="container" style="margin-top: 72px;padding-left: 24px;padding-right: 24px;">
            <div class="row">
                <div class="col-md-6 d-flex d-lg-flex flex-column justify-content-center align-items-center justify-content-lg-center align-items-lg-start justify-content-xxl-start" style="background: transparent;padding-left: 20px;padding-right: 20px;">
                    <h1 class="fs-1" style="font-family: Campton;color: #CE3827;margin-bottom: 15px;">PAKUWON INDAH</h1>
                    ...
                    <div style="background: transparent;padding-left: 0px;padding-right: 0px;padding-top: 0px;padding-bottom: 0px;">
                        <div style="margin-bottom: 12px;"><span class="badge rounded-pill fw-normal" style="background: #292F78;font-family: Campton;padding-top: 12px;padding-bottom: 12px;padding-left: 18px;padding-right: 18px;margin-right: 12px;">{{ __("Playgroup (PG)") }}</span><span class="badge rounded-pill fw-normal" style="background: #292F78;font-family: Campton;padding-top: 12px;padding-bottom: 12px;padding-left: 18px;padding-right: 18px;margin-right: 12px;">{{ __("Pre-Kindergarten") }}</span></div>
                        <div style="margin-bottom: 12px;"><span class="badge rounded-pill fw-normal" style="background: #292F78;font-family: Campton;padding-top: 12px;padding-bottom: 12px;padding-left: 18px;padding-right: 18px;margin-right: 12px;">{{ __("Kindergerten (K1 & K2)") }}</span></div>
                            ...
                            <div class="carousel-item active d-flex d-lg-flex align-items-end h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="/assets/img/Banner/Surabaya%20Facilities%20Playroom.jpg" alt="Slide Image" style="z-index: -1;">
                                <div class="flex-fill" style="padding-top: 0px;padding-left: 24px;padding-bottom: 24px;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h1 class="fs-3 fw-semibold" style="color: var(--bs-white);font-family: Campton;">{{ __("Playroom") }}</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item d-flex d-lg-flex align-items-end h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="/assets/img/Banner/Surabaya%20Facilities%20Hall.jpg" alt="Slide Image" style="z-index: -1;">
                                <div class="flex-fill" style="padding-top: 0px;padding-left: 24px;padding-bottom: 24px;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h1 class="fs-3 fw-semibold" style="color: var(--bs-white);font-family: Campton;">{{ __("Multifunction Hall") }}</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item d-flex d-lg-flex align-items-end h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="/assets/img/Banner/Surabaya%20Facilities%20ELC%20Clasroom.jpg" alt="Slide Image" style="z-index: -1;">
                                <div class="flex-fill" style="padding-top: 0px;padding-left: 24px;padding-bottom: 24px;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h1 class="fs-3 fw-semibold" style="color: var(--bs-white);font-family: Campton;">{{ __("ELC Classroom") }}</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item d-flex d-lg-flex align-items-end h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="/assets/img/Banner/Surabaya%20Facilities%20Laboratory.jpg" alt="Slide Image" style="z-index: -1;">
                                <div class="flex-fill" style="padding-top: 0px;padding-left: 24px;padding-bottom: 24px;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h1 class="fs-3 fw-semibold" style="color: var(--bs-white);font-family: Campton;">{{ __("Laboratory") }}</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item d-flex d-lg-flex align-items-end h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="/assets/img/Banner/Surabaya%20Facilities%20Library.jpg" alt="Slide Image" style="z-index: -1;">
                                <div class="flex-fill" style="padding-top: 0px;padding-left: 24px;padding-bottom: 24px;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h1 class="fs-3 fw-semibold" style="color: var(--bs-white);font-family: Campton;">{{ __("Library") }}</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <section>
        <div class="container">
            <div class="row d-xxl-flex align-items-xxl-center">
                <div class="col-md-6 col-xxl-6">
                    <div class="d-xxl-flex justify-content-xxl-center"><div><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.6029436985427!2d112.67292307466147!3d-7.2859356716081365!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fdfb7bde437b%3A0xd9c3537c3fdbeafe!2sSampoerna%20Academy%20Surabaya%20(Pakuwon%20Indah)!5e0!3m2!1sid!2sid!4v1729279363112!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div></div>
                </div>
                <div class="col-md-6 col-xxl-6">
                    <div class="card" style="border-top-left-radius: 15px;border-top-right-radius: 15px;border-bottom-right-radius: 15px;border-bottom-left-radius: 15px;border-style: none;background: #E4E4EB;">
                        <div class="card-body">
                            <div class="d-flex flex-row justify-content-between" style="padding-left: 40px;padding-right: 40px;margin-top: 0px;margin-bottom: 0px;padding-top: 40px;padding-bottom: 40px;">
                                <div>
                                    <h4 class="fs-4" style="font-family: Campton;margin-bottom: 30px;">{{ __("Visit Pakuwon Indah School") }}</h4>
                                    <div class="d-flex" style="margin-top: 0px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" style="margin-top: 4px;margin-right: 8px;">
                                        ...
                                        <p style="margin-bottom: 0px;">Jl. Pakuwon Indah Lontar Tim.<br>No PK 01 - 10, Lidah Wetan, Lakarsantri</p>
                                    </div>
        ...
        <div class="container" style="margin-top: 200px;">
            <div class="row d-xxl-flex align-items-xxl-center">
                <div class="col-md-6 col-xxl-6">
                    <div class="card" style="border-top-left-radius: 15px;border-top-right-radius: 15px;border-bottom-right-radius: 15px;border-bottom-left-radius: 15px;border-style: none;background: #E4E4EB;">
                        <div class="card-body">
                            <div class="d-flex flex-row justify-content-between" style="padding-left: 40px;padding-right: 40px;margin-top: 0px;margin-bottom: 0px;padding-top: 40px;padding-bottom: 40px;">
                                <div>
                                    <h4 class="fs-4" style="font-family: Campton;margin-bottom: 30px;">{{ __("Visit Grand Pakuwon School") }}</h4>
                                    <div class="d-flex" style="margin-top: 0px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" style="margin-top: 4px;margin-right: 8px;">
                                            <path d="M17.6569 16.6569C16.7202 17.5935 14.7616 19.5521 13.4138 20.8999C12.6327 21.681 11.3677 21.6814 10.5866 20.9003C9.26234 19.576 7.34159 17.6553 6.34315 16.6569C3.21895 13.5327 3.21895 8.46734 6.34315 5.34315C9.46734 2.21895 14.5327 2.21895 17.6569 5.34315C20.781 8.46734 20.781 13.5327 17.6569 16.6569Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M15 11C15 12.6569 13.6569 14 12 14C10.3431 14 9 12.6569 9 11C9 9.34315 10.3431 8 12 8C13.6569 8 15 9.34315 15 11Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <p style="margin-bottom: 0px;">Jl. Grand Pakuwon,<br>Banjar Sugihan, Tandes</p>
                                    </div>
                                    <div class="d-flex" style="margin-top: 16px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" style="margin-top: 4px;margin-right: 8px;">
                                            <path d="M12 8V12L15 15M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                ...
                <div class="col-md-6 col-xxl-6">
                    <div class="d-xxl-flex justify-content-xxl-center"><div><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.915914811716!2d112.66071497466096!3d-7.250410471222074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7ff67b9db9109%3A0xba86f2bc39518e74!2sSampoerna%20Academy%20Surabaya%20(Grand%20Pakuwon)!5e0!3m2!1sid!2sid!4v1729279446596!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div></div>
                </div>
            </div>
        </div>
    </section>
