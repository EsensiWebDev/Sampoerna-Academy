<section id="career">
    <section>
        <div class="d-flex align-items-end" style="height: 600px;background: url(&quot;assets/img/Banner/hero%20career.jpg&quot;) center / cover no-repeat;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 offset-lg-2 d-lg-flex justify-content-lg-end align-items-lg-center">
                    <div class="d-flex flex-column"><button class="btn btn-primary" type="button" style="font-family: Campton;margin-bottom: 16px;border-style: none;">{{ __("Apply Now") }}&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none">
