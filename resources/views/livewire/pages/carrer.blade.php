<section id="career">
    <section>
        <div class="d-flex align-items-end" style="height: 600px;background: url(&quot;assets/img/Banner/hero%20career.webp&quot;) center / cover no-repeat;">
            <div class="container" style="padding-bottom: 64px;">
                <div class="row">
                    <div class="col-md-12">
                        <h1 style="font-family: Campton;color: var(--bs-white);">{{ __("Career") }}</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section style="margin-top: 200px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div>
                        <h1 class="display-5 fw-semibold" style="font-family: Campton;color: var(--bs-black);">{{ __("Change The Game By Working At Sampoerna Academy") }}</h1>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-6 offset-lg-0">
                    <h1 class="fs-4 fw-normal" style="font-family: Campton;color: var(--bs-white);">{{ __("Find More About Job Opportunity") }}&nbsp;</h1>
                </div>
                <div class="col-md-6 col-lg-4 offset-lg-2 d-lg-flex justify-content-lg-end align-items-lg-center">

                        <div class="d-flex flex-column">
                            <a href="https://sampoernaschoolssystem.com/en/jobs/">
