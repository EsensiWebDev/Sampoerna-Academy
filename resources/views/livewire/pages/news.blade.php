                        ...
                        <div class="d-flex flex-row justify-content-start align-items-end"
                            ...
                            <div class="flex-fill px-5" style="padding-left: 140px;padding-bottom: 36px;">
                                <h1 class="fs-4 fw-semibold"
                                    style="color: var(--bs-black);font-family: Campton;margin-top: 8px;margin-bottom: 8px;">{!! app()->getLocale() == "id" ? $article->title_indonesia : $article->title_english !!}</h1>
                                <p class="fw-light"
                                   style="font-family: Campton;color: var(--bs-black);color:white!important;margin-top: 10px;">{!! app()->getLocale() == "id" ? $article->content_indonesia : $article->content_english !!}</p>
                                <a href="/news/{{ $article->slugs }}" style="font-family: Campton;color: #292F78;">{{ __("Read More") }}&nbsp;
                        ...
                        <div class="col col-6 col-sm-6 col-lg-4 py-2 px-2" wire:key="{{ $loop->iteration }}">
                            <a href="/news/{{ $article->slugs }}" style="color: black" wire:navigate.hover>
                                ...
                                <p class="fs-5 fw-light" style="color: var(--bs-black);font-family: Campton;">
                                    {!! app()->getLocale() == "id" ? \Illuminate\Support\Str::limit($article->content_indonesia, 60, '...') : \Illuminate\Support\Str::limit($article->content_english, 60, '...') !!}
                                </p>
                            </a>
                        </div>
                    @endforeach
